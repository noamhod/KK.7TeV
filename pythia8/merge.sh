...
hadd ${dir}${name}_mumu_50M150_4.root    ${dir}${name}_mumu_50M150_2.root    ${dir}${name}_mumu_50M150_3.root    ${dir}${name}_mumu_50M150_5.root    ${dir}${name}_mumu_50M150_6.root  
hadd ${dir}${name}_mumu_150M250_4.root   ${dir}${name}_mumu_150M250_2.root   ${dir}${name}_mumu_150M250_3.root   ${dir}${name}_mumu_150M250_5.root   ${dir}${name}_mumu_150M250_6.root
hadd ${dir}${name}_mumu_250M400_4.root   ${dir}${name}_mumu_250M400_2.root   ${dir}${name}_mumu_250M400_3.root   ${dir}${name}_mumu_250M400_5.root   ${dir}${name}_mumu_250M400_6.root
...
sed -i 's/200000/700000/g' ${dir}${name}_mumu_50M150_4.dat
sed -i 's/200000/700000/g' ${dir}${name}_mumu_150M250_4.dat
sed -i 's/200000/700000/g' ${dir}${name}_mumu_250M400_4.dat
