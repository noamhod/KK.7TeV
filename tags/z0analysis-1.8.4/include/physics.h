...
void physics::Init(TTree *tree)
{
   ...
   */
   ...
   //////////////////////////////////////////////////////////
   fChain->SetBranchStatus("EF_xe*",0);
   fChain->SetBranchStatus("EF_tau*",0);
   fChain->SetBranchStatus("EF_L1ItemStreamer*",0);
   fChain->SetBranchStatus("EF_2e*",0);
   fChain->SetBranchStatus("EF_4e*",0); 
   fChain->SetBranchStatus("EF_2g*",0);   
   fChain->SetBranchStatus("EF_2j*",0); 
   fChain->SetBranchStatus("EF_4j*",0); 
   fChain->SetBranchStatus("EF_e*",0); 
   fChain->SetBranchStatus("EF_fj*",0);
   fChain->SetBranchStatus("EF_j*",0); 
   fChain->SetBranchStatus("EF_x*",0); 
   fChain->SetBranchStatus("EF_g*",0); 
   fChain->SetBranchStatus("EF_mu0_*",0); 
   fChain->SetBranchStatus("EF_mu4_*",0); 
   fChain->SetBranchStatus("EF_mu6_*",0); 
   fChain->SetBranchStatus("EF_mu10_*",0); 
   fChain->SetBranchStatus("EF_mu30_*",0); 

   fChain->SetBranchStatus("L2_L1ItemStreamer*",0);
   fChain->SetBranchStatus("L2_e*",0); 
   fChain->SetBranchStatus("L2_g*",0); 
   fChain->SetBranchStatus("L2_x*",0); 
   fChain->SetBranchStatus("L2_f*",0); 
   fChain->SetBranchStatus("L2_g*",0); 
   fChain->SetBranchStatus("L2_j*",0); 
   fChain->SetBranchStatus("L2_2e*",0); 
   fChain->SetBranchStatus("L2_2g*",0); 
   fChain->SetBranchStatus("L2_2j*",0); 
   fChain->SetBranchStatus("L2_4j*",0); 
   fChain->SetBranchStatus("L2_mu0*",0); 
   fChain->SetBranchStatus("L2_mu4*",0); 
   fChain->SetBranchStatus("L2_mu6*",0); 
   fChain->SetBranchStatus("L2_mu10*",0); 
   fChain->SetBranchStatus("L2_mu30*",0); 
   fChain->SetBranchStatus("L2_tau*",0); 

   fChain->SetBranchStatus("L1_F*",0);
   fChain->SetBranchStatus("L1_J*",0); 
   fChain->SetBranchStatus("L1_EM*",0); 
   fChain->SetBranchStatus("L1_2TAU*",0); 
   fChain->SetBranchStatus("L1_4J*",0); 
   fChain->SetBranchStatus("L1_MU0_*",0); 
   fChain->SetBranchStatus("L1_MU6_*",0); 
   fChain->SetBranchStatus("L1_R*",0); 
   fChain->SetBranchStatus("L1_T*",0); 
   fChain->SetBranchStatus("L1_X*",0); 
   fChain->SetBranchStatus("L1_Z*",0); 
   //////////////////////////////////////////////////////////
   ...
   */
   ...
   fChain->SetBranchStatus("cl_*",0);
   fChain->SetBranchStatus("emcl_*",0);
   /*
   ...
   */
   ...
   fChain->SetBranchStatus("mb_*",0);   
   fChain->SetBranchStatus("mbtime_*",0);
