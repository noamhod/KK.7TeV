...
void offlineGridControlRun()
{
	...
	TString fileName ="offlineWZphys.root";
	...
	gROOT->ProcessLine(".L offlineGridControl.C++");
	gROOT->ProcessLine("offlineGridControl olgc(fChain, fout);");
	gROOT->ProcessLine("olgc.loop(0,0);");
}
