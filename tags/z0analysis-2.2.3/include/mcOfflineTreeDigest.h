...
#ifndef MCOFFLINETREEDIGEST_H
#define MCOFFLINETREEDIGEST_H

class mcOfflineTreeDigest : public utilities
{
	public:
		// pointers
	...
	public:
		mcOfflineTreeDigest();
		mcOfflineTreeDigest(mcOfflinePhysics* mcOffPhys, TFile* treeFile);
		~mcOfflineTreeDigest();
