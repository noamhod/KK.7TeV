...
void mcOfflineAnalysis::execute( string mualgo )
{
	...
	//m_muSkimD3PD->doSkimD3PD(); // NO NEED TO SKIM ON MC///////////////////////////////////
	bool passedSkim = true; // EVERYTHING PASSES ////////////////////////////////////////////
	if(passedSkim) //////////////////////////////////////////////////////////////////////////
	{              //////////////////////////////////////////////////////////////////////////
...
void mcOfflineAnalysis::setStacoVariables()
{
	...
	analysisSkeleton::mu_nTRTHits = m_mcOffPhys->mu_staco_nTRTHits;
...
void mcOfflineAnalysis::setMuidVariables()
{
	...
	analysisSkeleton::mu_nTRTHits = m_mcOffPhys->mu_muid_nTRTHits;
