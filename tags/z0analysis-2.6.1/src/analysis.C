...
void analysis::execute( string mualgo )
{
	...
	bool passedSkim = m_muD3PD->doSkimD3PD(pTthreshold); //////////////////////////////////////////////////////////////
	if(passedSkim) m_muD3PD->fill(analysisSkeleton::isGRL, analysisSkeleton::sPeriod, analysisSkeleton::vTriggers); ///
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
