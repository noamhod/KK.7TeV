...
TGraphAsymmErrors* GetPoissonizedGraph(TH1* histo, bool isXerr)
{
...
TGraphAsymmErrors* GetSqrtErrorsGraph(TH1* histo, bool isXerr)
{
	TGraphAsymmErrors* graph = new TGraphAsymmErrors();
...
TGraphAsymmErrors* GetDefaultErrorsGraph(TH1* histo, bool isXerr)
{
        TGraphAsymmErrors* graph = new TGraphAsymmErrors();
...
void resetHistogramErrors(TH1* histo)
{
