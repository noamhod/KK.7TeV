...
void hamp()
{
	...
	TH1D* h1KK     = new TH1D("h1KK","DY(black),     "+mBSM+" TeV Z'_{SSM}(blue), "+mBSM+" TeV KK(red) and "+mBSM+" TeV KKonly(green);m_{#mu#mu} GeV;arbitrary scale", Nx,xMin,xMax);
	TH1D* h1KKnoSM = new TH1D("h1KKnoSM","DY(black), "+mBSM+" TeV Z'_{SSM}(blue), "+mBSM+" TeV KK(red) and "+mBSM+" TeV KKonly(green);m_{#mu#mu} GeV;arbitrary scale", Nx,xMin,xMax);
	TH1D* h1ZP     = new TH1D("h1ZP","DY(black),     "+mBSM+" TeV Z'_{SSM}(blue), "+mBSM+" TeV KK(red) and "+mBSM+" TeV KKonly(green);m_{#mu#mu} GeV;arbitrary scale", Nx,xMin,xMax);
	TH1D* h1SM     = new TH1D("h1SM","DY(black),     "+mBSM+" TeV Z'_{SSM}(blue), "+mBSM+" TeV KK(red) and "+mBSM+" TeV KKonly(green);m_{#mu#mu} GeV;arbitrary scale", Nx,xMin,xMax);
	...
	h1KK->SetLineStyle(5);
	h1KKnoSM->SetLineColor(kGreen+2);
	h1KKnoSM->SetLineStyle(5);
	
	TH1D* h1AsymKK     = new TH1D("h1AsymKK","DY(black),     "+mBSM+" TeV Z'_{SSM}(blue), "+mBSM+" TeV KK(red) and "+mBSM+" TeV KKonly(green);m_{#mu#mu} GeV;A_{fb}", Nx,xMin,xMax);
	TH1D* h1AsymKKnoSM = new TH1D("h1AsymKKnoSM","DY(black), "+mBSM+" TeV Z'_{SSM}(blue), "+mBSM+" TeV KK(red) and "+mBSM+" TeV KKonly(green);m_{#mu#mu} GeV;A_{fb}", Nx,xMin,xMax);
	TH1D* h1AsymZP     = new TH1D("h1AsymZP","DY(black),     "+mBSM+" TeV Z'_{SSM}(blue), "+mBSM+" TeV KK(red) and "+mBSM+" TeV KKonly(green);m_{#mu#mu} GeV;A_{fb}", Nx,xMin,xMax);
	TH1D* h1AsymSM     = new TH1D("h1AsymSM","DY(black),     "+mBSM+" TeV Z'_{SSM}(blue), "+mBSM+" TeV KK(red) and "+mBSM+" TeV KKonly(green);m_{#mu#mu} GeV;A_{fb}", Nx,xMin,xMax);
	...
	h1AsymKKnoSM->SetLineColor(kGreen+2);
	...
	TH1D* h1rKK     = new TH1D("h1rKK",     "Z'_{SSM}(blue), KK(red) and KKonly(green);m_{#mu#mu} GeV;ME^{2}_{BSM}/ME^{2}_{DY}", Nx,xMin,xMax);
	TH1D* h1rKKnoSM = new TH1D("h1rKKnoSM", "Z'_{SSM}(blue), KK(red) and KKonly(green);m_{#mu#mu} GeV;ME^{2}_{BSM}/ME^{2}_{DY}", Nx,xMin,xMax);
	TH1D* h1rZP     = new TH1D("h1rZP",     "Z'_{SSM}(blue), KK(red) and KKonly(green);m_{#mu#mu} GeV;ME^{2}_{BSM}/ME^{2}_{DY}", Nx,xMin,xMax);
	h1rZP->SetLineColor(kBlue);
	h1rZP->SetLineStyle(3);
	h1rKK->SetLineColor(kRed);
	h1rKK->SetLineStyle(5);
	h1rKKnoSM->SetLineColor(kGreen+2);
	...
	TH2D* h2rKKnoSM = new TH2D("h2rKKnoSM", mBSM+" TeV KKonly;m_{#mu#mu} GeV;cos#theta*;ME^{2}_{BSM}/ME^{2}_{DY}", Nx,xMin,xMax, Ny,yMin,yMax);
	...
	TH2D* h2KKnoSM = new TH2D("h2KKnoSM", mBSM+" TeV KKonly;m_{#mu#mu} GeV;cos#theta*;arbitrary scale", Nx,xMin,xMax, Ny,yMin,yMax);
	...
	cnv_2dr->Divide(1,3);
	TVirtualPad* pad_2drKK = cnv_2dr->cd(3);
	TVirtualPad* pad_2drKKnoSM = cnv_2dr->cd(2);
	...
	cnv_2d->Divide(1,4);
	TVirtualPad* pad_2dKK = cnv_2d->cd(4);
	TVirtualPad* pad_2dKKnoSM = cnv_2d->cd(3);
