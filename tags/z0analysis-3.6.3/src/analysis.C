...
void analysis::execute()
{
	...
	if(analysisSkeleton::do2MUselection) applyTagNProbe( (*m_cutsFlowSkipMap) ); ////
	/////////////////////////////////////////////////////////////////////////////////
	...
	if(sRunType=="local_noskim" && m_isMC && analysisSkeleton::do2MUselection) applyTruth(); /////
	//////////////////////////////////////////////////////////////////////////////////////////////
	...
	// if(analysisSkeleton::do2MUselection) fillCutProfile(); ///////
	//////////////////////////////////////////////////////////////
	...
	if(!analysisSkeleton::do2MUselection) return; ///////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////////
