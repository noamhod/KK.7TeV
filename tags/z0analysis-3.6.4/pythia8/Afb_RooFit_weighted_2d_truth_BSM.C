...
vector<double>* truth_all_mc_px;
vector<double>* truth_all_mc_py;
vector<double>* truth_all_mc_pz;
vector<double>* truth_all_mc_E;
vector<double>* truth_all_mc_pt;
vector<double>* truth_all_mc_m;
vector<double>* truth_all_mc_eta;
vector<double>* truth_all_mc_phi;
vector<int>*    truth_all_mc_status;
vector<int>*    truth_all_mc_barcode;
vector<int>*    truth_all_mc_pdgId;
vector<double>* truth_all_mc_charge;

vector<double>* truth_all_partons_mc_px;
vector<double>* truth_all_partons_mc_py;
vector<double>* truth_all_partons_mc_pz;
vector<double>* truth_all_partons_mc_E;
vector<double>* truth_all_partons_mc_pt;
vector<double>* truth_all_partons_mc_m;
vector<double>* truth_all_partons_mc_eta;
vector<double>* truth_all_partons_mc_phi;
vector<int>*    truth_all_partons_mc_status;
vector<int>*    truth_all_partons_mc_barcode;
vector<int>*    truth_all_partons_mc_pdgId;
vector<double>* truth_all_partons_mc_charge;
...
TString sBSMmodel = (isKK) ? "S^{1}/Z_{2} KK" : "Z'_{SSM}";

TString sChannelFit   = "1.5 TeV "+sBSMmodel+" [#scale[1.1]{P}#scale[0.9]{YTHIA8} Truth]: A_{FB} fit";
TString sChannelCount = "1.5 TeV "+sBSMmodel+" [#scale[1.1]{P}#scale[0.9]{YTHIA8} Truth]: A_{FB} count";
TString sChannelMass  = "1.5 TeV "+sBSMmodel+" [#scale[1.1]{P}#scale[0.9]{YTHIA8} Truth]: Events";
...
TFile* fDYmumuPyQ = new TFile("fitplots/PyQ_DYmumu_all.root", "READ");
TH1D*  hDYmumuPyQ;
...
void settree(TString fPath, TString name, Double_t N, Double_t sigma)
{
	...
	if(isKK) treMap.insert( make_pair(name, (TTree*)f->Get("truth/truth_tree")->Clone("")) );
	else     treMap.insert( make_pair(name, (TTree*)f->Get("truth_tree")->Clone("")) );
...
void settrees()
{
	...
	if(isKK)
	{
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_75M120.root",    "Pythia8_KK_1500mumu_75M120", 20000, 7.096e-07*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_120M250.root",   "Pythia8_KK_1500mumu_120M250", 20000, 7.180e-09*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_250M400.root",   "Pythia8_KK_1500mumu_250M400", 20000, 2.708e-10*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_400M600.root",   "Pythia8_KK_1500mumu_400M600", 20000, 2.506e-11*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_600M800.root",   "Pythia8_KK_1500mumu_600M800", 20000, 6.954e-13*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_800M1000.root",  "Pythia8_KK_1500mumu_800M1000", 20000, 7.876e-13*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_1000M1250.root", "Pythia8_KK_1500mumu_1000M1250", 20000, 4.020e-12*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_1250M1500.root", "Pythia8_KK_1500mumu_1250M1500", 20000, 4.712e-11*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_1500M1750.root", "Pythia8_KK_1500mumu_1500M1750", 20000, 3.352e-11*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_1750M2000.root", "Pythia8_KK_1500mumu_1750M2000", 20000, 3.949e-13*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8KK/Pythia8_KK_1500mumu_M2000.root",     "Pythia8_KK_1500mumu_M2000", 20000, 2.570e-13*mb2fb);
	}
	else
	{
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_75M120.root",    "Pythia8_Zprime_1500mumu_75M120", 20000, 7.061e-07*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_120M250.root",   "Pythia8_Zprime_1500mumu_120M250", 20000, 7.451e-09*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_250M400.root",   "Pythia8_Zprime_1500mumu_250M400", 20000, 3.458e-10*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_400M600.root",   "Pythia8_Zprime_1500mumu_400M600", 20000, 5.308e-11*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_600M800.root",   "Pythia8_Zprime_1500mumu_600M800", 20000, 7.954e-12*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_800M1000.root",  "Pythia8_Zprime_1500mumu_800M1000", 20000, 1.673e-12*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_1000M1250.root", "Pythia8_Zprime_1500mumu_1000M1250", 20000, 5.361e-13*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_1250M1500.root", "Pythia8_Zprime_1500mumu_1250M1500", 20000, 4.647e-12*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_1500M1750.root", "Pythia8_Zprime_1500mumu_1500M1750", 20000, 4.384e-12*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_1750M2000.root", "Pythia8_Zprime_1500mumu_1750M2000", 20000, 1.069e-13*mb2fb);
		settree("/data/hod/pythia8_ntuples/NEWPYTHIA8ZP/Pythia8_Zprime_1500mumu_M2000.root",     "Pythia8_Zprime_1500mumu_M2000", 20000, 3.120e-14*mb2fb);
	}
}

void parseDYbinName(string name, Double_t& massbinlowedge, Double_t& massbinhighedge)
{
	string prefix = "Pythia8_Zprime_1500mumu_";
	if(isKK) prefix = "Pythia8_KK_1500mumu_";
...
void setbranches()
{
	...
	tree->SetBranchAddress("truth_all_mc_px",   &truth_all_mc_px);
	tree->SetBranchAddress("truth_all_mc_py",   &truth_all_mc_py);
	tree->SetBranchAddress("truth_all_mc_pz",   &truth_all_mc_pz);
	tree->SetBranchAddress("truth_all_mc_E",   &truth_all_mc_E);
	...
	tree->SetBranchAddress("truth_all_partons_mc_px", &truth_all_partons_mc_px);
	tree->SetBranchAddress("truth_all_partons_mc_py", &truth_all_partons_mc_py);
	tree->SetBranchAddress("truth_all_partons_mc_pz", &truth_all_partons_mc_pz);
	tree->SetBranchAddress("truth_all_partons_mc_E", &truth_all_partons_mc_E);
...
Int_t loop(int massBin)
{
	...
	for(TMapTSP2TTREE::iterator it=treMap.begin() ; it!=treMap.end() ; ++it)
	{
		...
		for(Int_t entry=0 ; entry<N ; entry++)
		{
			...
			tlvmua->SetPxPyPzE(truth_all_mc_px->at(imuontru),truth_all_mc_py->at(imuontru),truth_all_mc_pz->at(imuontru),truth_all_mc_E->at(imuontru));
			tlvmub->SetPxPyPzE(truth_all_mc_px->at(iamuontru),truth_all_mc_py->at(iamuontru),truth_all_mc_pz->at(iamuontru),truth_all_mc_E->at(iamuontru));
			double YQ   = ySystem(tlvmua,tlvmub);
			double mHat = imass(tlvmua,tlvmub);
			
			// reject events that do not come from the relevant DY bin
			...
			tlvqa->SetPxPyPzE(truth_all_partons_mc_px->at(iquark), truth_all_partons_mc_py->at(iquark), truth_all_partons_mc_pz->at(iquark),truth_all_partons_mc_E->at(iquark));
			tlvqb->SetPxPyPzE(truth_all_partons_mc_px->at(iaquark), truth_all_partons_mc_py->at(iaquark), truth_all_partons_mc_pz->at(iaquark),truth_all_partons_mc_E->at(iaquark));
			...
			tv3mua->SetXYZ(tlvmuaBoosted->Px(),tlvmuaBoosted->Py(),tlvmuaBoosted->Pz());
	...
	hDYmumuPyQ = (TH1D*)fDYmumuPyQ->Get("massbin_"+(TString)_s(massBin));
	if(takeDYmumuPyQ) sigPdf = new RooFBfalseIdentifyCS("SignalPdf", "SignalPdf", *cosThe,*yQ,*A0,*A4,*hDYmumuPyQ);
	else              sigPdf = new RooFBfalseIdentifyCS("SignalPdf", "SignalPdf", *cosThe,*yQ,*A0,*A4,*vhPyQ[massBin-1]);
	modelPdf = sigPdf;
...
void plot(int massbin)
{
	...
	cnv->Update();
	TString sModel = (isKK) ? "KK" : "Zprime";
	cnv->SaveAs("fitplots/"+sModel+"_truth_2d_FitMassBin_" + sMassBin + ".root");
	cnv->SaveAs("fitplots/"+sModel+"_truth_2d_FitMassBin_" + sMassBin + ".C");
	cnv->SaveAs("fitplots/"+sModel+"_truth_2d_FitMassBin_" + sMassBin + ".eps");
	cnv->SaveAs("fitplots/"+sModel+"_truth_2d_FitMassBin_" + sMassBin + ".ps");
	cnv->SaveAs("fitplots/"+sModel+"_truth_2d_FitMassBin_" + sMassBin + ".pdf");
	cnv->SaveAs("fitplots/"+sModel+"_truth_2d_FitMassBin_" + sMassBin + ".png");
	delete cnv;
}
...
void drawAfb()
{
	...
	TString sModel = (isKK) ? "KK" : "Zprime";
	cnvAfb->SaveAs("fitplots/"+sModel+"_truth_2d_FitAfb.root");
	cnvAfb->SaveAs("fitplots/"+sModel+"_truth_2d_FitAfb.C");
	cnvAfb->SaveAs("fitplots/"+sModel+"_truth_2d_FitAfb.eps");
	cnvAfb->SaveAs("fitplots/"+sModel+"_truth_2d_FitAfb.ps");
	cnvAfb->SaveAs("fitplots/"+sModel+"_truth_2d_FitAfb.pdf");
	cnvAfb->SaveAs("fitplots/"+sModel+"_truth_2d_FitAfb.png");
}
...
void drawPyQ(int massBin)
{
	...
	TString sModel = (isKK) ? "KK" : "Zprime";
	cnvPyQ->SaveAs("fitplots/"+sModel+"_PyQ_"+sMassBin+".png");
	cnvPyQ->SaveAs("fitplots/"+sModel+"_PyQ_"+sMassBin+".eps");
	cnvPyQ->SaveAs("fitplots/"+sModel+"_PyQ_"+sMassBin+".pdf");
	cnvPyQ->SaveAs("fitplots/"+sModel+"_PyQ_"+sMassBin+".ps");
	cnvPyQ->SaveAs("fitplots/"+sModel+"_PyQ_"+sMassBin+".root");
	cnvPyQ->SaveAs("fitplots/"+sModel+"_PyQ_"+sMassBin+".C");
	
	TFile* f = new TFile("fitplots/PyQ_"+sModel+"_all.root","UPDATE");
	f->cd();
...
void Afb_RooFit_weighted_2d_truth_BSM()
{
	...
	TString sModel = (isKK) ? "KK" : "Zprime";
	TFile* fTmp = new TFile("fitplots/PyQ_"+sModel+"_all.root","RECREATE");
	fTmp->Write();
	fTmp->Close();
	delete fTmp;
