...
[
	...
	"#{root} hstack.C+ --ftype=noPUrw_noEWkFsig_noCoupScale --htype=IsolationFull    --istru=0",
	"#{root} hstack.C+ --ftype=noPUrw_noEWkFsig_noCoupScale --htype=IsolationLow     --istru=0",
	"#{root} hstack.C+ --ftype=noPUrw_noEWkFsig_noCoupScale --htype=MassAntiIsolated --istru=0",
]
outlist = []
