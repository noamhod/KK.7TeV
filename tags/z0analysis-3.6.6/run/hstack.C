...
void hstack()
{
	...
	bool doSignals   = (htype.Contains("Mass") || htype.Contains("pT")) ? true : false;
	...
	TText* txt = NULL;
	TPaveText* pvtxt_atlas = new TPaveText(xtxtmin,0.6,xtxtmax,0.85,"brNDC");
