...
// Thu Nov 25 23:45:06 2010 by ROOT version 5.26/00
// from TTree digest/digest
// found on file: mcDigestTree_mcWZphys_localTests.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mcDigestTree_mcWZphys_localTests.root");
      if (!f) {
         f = new TFile("mcDigestTree_mcWZphys_localTests.root");
      }
...
void mcDigestPhysics::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("vxp_err", &vxp_err, &b_vxp_err);
