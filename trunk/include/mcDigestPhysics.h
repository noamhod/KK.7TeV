...
// Sun Nov 14 16:44:55 2010 by ROOT version 5.22/00
// from TTree digest/digest
// found on file: mcOfflineTreeDigest_Zprime_mumu_SSM1000.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mcOfflineTreeDigest_Zprime_mumu_SSM1000.root");
      if (!f) {
         f = new TFile("mcOfflineTreeDigest_Zprime_mumu_SSM1000.root");
      }
