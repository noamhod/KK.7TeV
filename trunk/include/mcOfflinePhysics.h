...
// Mon Nov  8 00:21:52 2010 by ROOT version 5.22/00
// from TTree offline/offline
// found on file: user.hod.002039._00001.mcWZphys.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("user.hod.002039._00001.mcWZphys.root");
      if (!f) {
         f = new TFile("user.hod.002039._00001.mcWZphys.root");
      }
