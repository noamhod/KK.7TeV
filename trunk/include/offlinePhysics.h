...
// Thu Nov 25 17:48:17 2010 by ROOT version 5.26/00
// from TTree offline/offline
// found on file: WZphys.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("WZphys.root");
      if (!f) {
         f = new TFile("WZphys.root");
      }
