...
nameprefix = "user.wanghill.data11_7TeV.00"

x = Analysis.new(false)
x.batch_analyze(insets,outlist,runnumbers,sourcedir,targetdir,macrodir,nameprefix)
x.merge(runnumbers,"merged.root",targetdir,"#{targetdir}/..")
#x.finalize(targetdir,macrodir)
