...
x.set_sourcedir("/data/hod/2011/NTUP_SMDILEP_dimuon_p591")
x.set_targetdir("/srv01/tau/hod/z0analysis-tests/z0analysis-t302/data/tmp")
x.set_macrodir("/srv01/tau/hod/z0analysis-tests/z0analysis-t302/run/tmp")
x.set_jobdir("/srv01/tau/hod/z0analysis-tests/z0analysis-t302/scripts/tmp")
x.set_prefix("user.wanghill.data11_7TeV.00",6)
x.set_secondprefix("._",5)

x.batch_qsub(insets,runnumbers)
#x.merge(runnumbers,"merged.root")
x.finalize()
